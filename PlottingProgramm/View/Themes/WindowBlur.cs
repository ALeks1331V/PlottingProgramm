...
namespace Walterlv.Demo.Interop
{
    public class WindowBlur
    {
        ...
        /*
         Создаем объект класса DependencyProperty 
         RegisterAttached ввозвращает идентификатор свойства зависимости (property identifier), который следует 
         использовать для установки значения общедоступного статического поля, доступного только для чтения, в классe.
         Параметры: Имя регистрируемого свойства зависимости. Тип свойства. Тип владельца, который регистрирует свойство зависимости.
         Метаданные: Определяют аспекты поведения свойства зависимости при его применении к
         определенному типу, включая условия, при которых оно было зарегистрировано.
        */
